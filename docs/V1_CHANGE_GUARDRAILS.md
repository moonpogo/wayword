...
If a change needs to cross one of these guardrails, call out the risk explicitly in the PR or task summary. Historical implementation notes live in `docs/archive/BUILD_LOG.md`.
